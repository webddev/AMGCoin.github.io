      ...
      function animateTl(scrolling, el, tl) {
        ...
        for (let i = 0; i < el.length; i++) {
          el[i].addEventListener("click", function() {
            ...
            if (this.classList.contains("arrow__prev")) --counter_2;
            else ++counter_2;
            if (counter === 0) {
            ...
            setTimeout(() => {
              counter_2 == 0 ? setBtnState(arrowPrev) : setBtnState(arrowPrev, false);
              counter_2 == 7 ? setBtnState(arrowNext) : setBtnState(arrowNext, false);
            }, 1100);
